...
ImmunePredictor is responsible for computing immunogenicity and self similarity scores for input peptides.
An example on how to use the package in python follows here:
